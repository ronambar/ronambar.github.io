...
Comments: 	1. The application allows the user to play music using pads,
		and provides the abilities to record, save current state and load it.
		2. HTML, CSS, JS files are used to implement the program.
		3. The recording logic allows the user to record a segment,
		 and at the end of the recording the user will be able to play it.
		(as long as he has not recorded new segment or loaded a saved one).
